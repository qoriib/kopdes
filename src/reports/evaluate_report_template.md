...
<img src="figures/eval_pca_projection.png" alt="Proyeksi PCA 2D" width="500">

### B. Distribusi Anggota Klaster
<img src="figures/eval_cluster_distribution.png" alt="Distribusi Anggota" width="500">

### C. Profil Fitur Utama per Klaster
<img src="figures/eval_avg_transaction.png" alt="Rata-rata Fitur Utama" width="500">

## 3. Profil Klaster Berdasarkan Fitur Terpilih

{{cluster_profile_rows}}

## 4. Ringkasan Distribusi Anggota Klaster
