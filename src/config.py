...
NOTEBOOKS_OUT_DIR = os.path.join(NOTEBOOKS_DIR, "outs")
...
# Stage 1: Understanding Output Paths
...
# Stage 2: Preparation Output Paths
...
# Stage 4: Evaluation Output Paths
...
# Stage 5: Deployment Output Paths
